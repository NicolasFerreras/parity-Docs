...
The exported Excel file is formatted to meet the requirements of the wholesaler’s **internal billing system**. It is the same format that employees currently create manually in Excel—Parity generates it automatically.
